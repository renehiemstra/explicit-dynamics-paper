...
function f = assemble_standard_forcing_vector(coeffs, discretization, material, forces, flag_mex)
    ...
    if (flag_mex==true)
        ...
        % call C function
        mex_quadrature_loop_standard(m1, m2, kappa, ...
            quadrature.sumfact, ...
            weights, ...
            forces_eval, ...
            displacement.ders,...
        ...
        quadrature.sumfact = mat_quadrature_loop_standard(m1, m2, kappa, ...
            quadrature.sumfact, ...
            weights, ...
            forces_eval, ...
            displacement.ders,...
    ...
    if strcmp(discretization.method, 'standard')
        f = reshape(discretization.chol \ (discretization.chol' \ f(:)), discretization.basis{1}.dim, discretization.basis{2}.dim);
