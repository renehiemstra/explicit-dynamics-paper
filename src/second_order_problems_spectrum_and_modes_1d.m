function [S, X, kts]  = second_order_problems_spectrum_and_modes_1d(p, ndofs, bcs, remove_outliers)
    ...
    M = N(1:2:end, :)' * W * N(1:2:end, :); MM = C' * M * C;
    ...
    [S,X] = spectrum_and_modes(U' \ KK / U);             X = U \ X;
