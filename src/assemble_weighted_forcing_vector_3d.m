...
function f = assemble_weighted_forcing_vector_3d(coeffs, discretization, material, forces, flag_mex)
    ...
    if (flag_mex==true)
        ...
        % call C function
        mex_quadrature_loop_weighted_3d(m1, m2, m3, ...
            kappa, ...
            quadrature.sumfact, ...
            weights, ...
            forces_eval, ...
        ...
        quadrature.sumfact = mat_quadrature_loop_weighted_3d(m1, m2, m3, ...
            kappa, ...
            quadrature.sumfact, ...
            weights, ...
            forces_eval, ...
    ...
    f = tensorconstract(quadrature.sumfact{1}, basis{1}.scaledtestfuns{2}, basis{2}.scaledtestfuns{1}, basis{3}.scaledtestfuns{1}, 1) + ...
        tensorconstract(quadrature.sumfact{2}, basis{1}.scaledtestfuns{1}, basis{2}.scaledtestfuns{2}, basis{3}.scaledtestfuns{1}, 1) + ...
        tensorconstract(quadrature.sumfact{3}, basis{1}.scaledtestfuns{1}, basis{2}.scaledtestfuns{1}, basis{3}.scaledtestfuns{2}, 1) + ...
        tensorconstract(quadrature.sumfact{4}, basis{1}.scaledtestfuns{1}, basis{2}.scaledtestfuns{1}, basis{3}.scaledtestfuns{1}, 1);
