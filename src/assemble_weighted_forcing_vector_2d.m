...
function f = assemble_weighted_forcing_vector_2d(coeffs, discretization, material, forces, flag_mex)
    ...
    if (flag_mex==true)
        ...
        % call C function
        mex_quadrature_loop_weighted_2d(m1, m2, kappa, ...
            quadrature.sumfact, ...
            weights, ...
            forces_eval, ...
            displacement.ders,...
        ...
        quadrature.sumfact = mat_quadrature_loop_weighted_2d(m1, m2, kappa, ...
            quadrature.sumfact, ...
            weights, ...
            forces_eval, ...
            displacement.ders,...
    ...
    f = tensorconstract(quadrature.sumfact{1}, basis{1}.scaledtestfuns{2}, basis{2}.scaledtestfuns{1}, 1) + ...
        tensorconstract(quadrature.sumfact{2}, basis{1}.scaledtestfuns{1}, basis{2}.scaledtestfuns{2}, 1) + ...
        tensorconstract(quadrature.sumfact{3}, basis{1}.scaledtestfuns{1}, basis{2}.scaledtestfuns{1}, 1);
