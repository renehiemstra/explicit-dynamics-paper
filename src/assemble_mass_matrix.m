...
function M = assemble_mass_matrix(discretization, flag_mex)
    ...
    if (flag_mex==true)
        ...
        % call C function
        mex_quadrature_loop_standard_mass(m1, m2, ...
            quadrature.sumfact, ...
            weights, ...
            geometry.jacobian);
    else
        quadrature.sumfact = mat_quadrature_loop_standard_mass(m1, m2, ...
            quadrature.sumfact, ...
            weights, ...
            geometry.jacobian);
    end
