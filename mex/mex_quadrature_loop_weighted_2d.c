            ...
            double *hessian[3][2])
{
    ...
    for (l=0; l<m2; l++) {
        ...
        for (k=0; k<m1; k++){
            ...
            DA[0][0] = hessian[0][0][lindex]; DA[0][1] = hessian[0][1][lindex];
            DA[1][0] = hessian[1][0][lindex]; DA[1][1] = hessian[1][1][lindex];
            DA[2][0] = hessian[2][0][lindex]; DA[2][1] = hessian[2][1][lindex];
            ...
            // compute gradient of volume element
            c_u = DA[0][0] * A[1][1] + A[0][0] * DA[2][1] - DA[2][0] * A[1][0] - A[0][1] * DA[0][1];
            c_v = DA[2][0] * A[1][1] + A[0][0] * DA[1][1] - DA[1][0] * A[1][0] - A[0][1] * DA[2][1];
            c_grad[0] = Ainv[0][0] * c_u + Ainv[1][0] * c_v;
            c_grad[1] = Ainv[0][1] * c_u + Ainv[1][1] * c_v;
            ...
            g[2] = forcing[lindex] + ((q[0] * c_grad[0] + q[1] * c_grad[1]) / c);
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    hessian[0][0] = mxGetDoubles(mxGetCell(prhs[8], 0)); 
    hessian[1][0] = mxGetDoubles(mxGetCell(prhs[8], 1)); 
    hessian[2][0] = mxGetDoubles(mxGetCell(prhs[8], 2));
    hessian[0][1] = mxGetDoubles(mxGetCell(prhs[8], 3)); 
    hessian[1][1] = mxGetDoubles(mxGetCell(prhs[8], 4)); 
    hessian[2][1] = mxGetDoubles(mxGetCell(prhs[8], 5));
